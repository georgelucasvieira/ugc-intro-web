...
<header class="header">
    <div class="header-container">
        <a class="brand" href="/ugc-intro-web/">Analyzer</a>
        
        <div class="container">
            <button id="toggle-theme" on:click={toggleTheme}>
                <svg xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 36 36">
                    <g id="Lager_93" data-name="Lager 93" transform="translate(2 2)">
                      <g id="Sun_3_Brightness_3" data-name="Sun 3, Brightness 3">
                        <path id="Path_68" data-name="Path 68" d="M32,14H27.033c-2,1.769-.779,4,.967,4h4.967C34.966,16.231,33.746,14,32,14Z" fill="currentColor"/>
